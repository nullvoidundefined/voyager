...
let searchExperiences: typeof import('app/tools/experiencesTool.js').searchExperiences;
...
describe('experiencesTool', () => {
  beforeEach(async () => {
    ...
    vi.doMock('app/tools/mock/experiencesMock.js', () => ({
      generateMockExperiences: vi.fn(),
    }));

    process.env.GOOGLE_PLACES_API_KEY = 'test-api-key';

    const expMod = await import('app/tools/experiencesTool.js');
