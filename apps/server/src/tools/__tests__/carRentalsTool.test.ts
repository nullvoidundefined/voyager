...
let searchCarRentals: typeof import('app/tools/carRentalsTool.js').searchCarRentals;
...
describe('carRentalsTool', () => {
  beforeEach(async () => {
    ...
    vi.doMock('app/tools/mock/carRentalsMock.js', () => ({
      generateMockCarRentals: vi.fn(),
    }));

    const carRentalMod = await import('app/tools/carRentalsTool.js');
